...
BALENA_CONFIGS_append = " smsc95xx"
BALENA_CONFIGS[smsc95xx] = "CONFIG_USB_NET_SMSC95XX=m"
...
BALENA_CONFIGS_append = " mmc_module"
BALENA_CONFIGS[mmc_module] = "\
    CONFIG_MMC=m \
    CONFIG_MMC_BLOCK=m \
    CONFIG_MMC_SDHCI=m \
...
BALENA_CONFIGS_append = " i2c_module"
BALENA_CONFIGS[i2c_module] = "\
...
BALENA_CONFIGS_append = " dwc3_host_mode"
BALENA_CONFIGS[dwc3_host_mode] = "CONFIG_USB_DWC3_HOST=y"

# enable ftdi_sio as a module (as requested by customer)
BALENA_CONFIGS_append = " ftdi_sio"
BALENA_CONFIGS[ftdi_sio] = "CONFIG_USB_SERIAL_FTDI_SIO=m"

# let's allow for /dev/i2c-* devices to be created (this enables userspace to use the I2C buses)
BALENA_CONFIGS_append = " i2c_chardev"
BALENA_CONFIGS[i2c_chardev] = "CONFIG_I2C_CHARDEV=y"

# compile uvcvideo.ko (as requested by customer)
BALENA_CONFIGS_append = " uvcvideo"
BALENA_CONFIGS[uvcvideo] = "CONFIG_USB_VIDEO_CLASS=m"
...
BALENA_CONFIGS_append = " cdc-acm"
BALENA_CONFIGS[cdc-acm] = "CONFIG_USB_ACM=m"

# add support for fuse (as requested by customer)
BALENA_CONFIGS_append = " fuse"
BALENA_CONFIGS[fuse] = "CONFIG_FUSE_FS=m"
